...
//  We don't want the original ROLE_USER or any of the SCOPE_ as authorities
//
...
//        authorities.addAll(TokenUtil.tokenClaimsToAuthorities(user.getAttributes(), groupClaim));
        Set<GrantedAuthority> authorities = new HashSet<>(TokenUtil.tokenClaimsToAuthorities(user.getAttributes(), groupClaim));

// We don't want the sub (clientId) but the Okta username
//
